...
export const SearchWithGroups = () => {
  ...
  const [results, setResults] = useState<SearchOverGroupsResults | null>(null);
    ...
    <Transition.Root show={true} as={Fragment} afterLeave={() => {}} appear>
      <Dialog as="div" className="relative z-10" onClose={() => {}}>
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto p-4 sm:p-6 md:p-20">
          ...
          >
            <Dialog.Panel className="mx-auto transform overflow-hidden rounded-md bg-white shadow-2xl ring-1 ring-black ring-opacity-5 transition-all">
              <Combobox
